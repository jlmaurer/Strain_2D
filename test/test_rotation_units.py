...
class Tests(unittest.TestCase):
    ...
    def test_euler_pole_rotation(self):
        ...
        [Ve, Vn, Se, Sn, rot_flat, exx, exy, eyy, vels, resids] = constructed_object.compute(myvelfield)  # computing strain
        output_manager.outputs_2d(Ve, Vn, Se, Sn, rot_flat, exx, exy, eyy, delaunay_flat_params, vels, resids)  # 2D grid outputs
        ...
        [Ve, Vn, Se, Sn, rot_del, exx, exy, eyy, vels, resids] = constructed_object.compute(myvelfield)  # computing strain
        output_manager.outputs_2d(Ve, Vn, Se, Sn, rot_del, exx, exy, eyy, delaunay_params, vels, resids)  # 2D grid output format
        ...
        [Ve, Vn, Se, Sn, rot_gps, exx, exy, eyy, vels, resids] = constructed_object.compute(myvelfield)  # computing strain
        output_manager.outputs_2d(Ve, Vn, Se, Sn, rot_gps, exx, exy, eyy, gpsgridder_params, vels, resids)  # 2D grid output format
        ...
        [Ve, Vn, Se, Sn, rot_visr, exx, exy, eyy, vels, resids] = constructed_object.compute(myvelfield)  # computing strain
        output_manager.outputs_2d(Ve, Vn, Se, Sn, rot_visr, exx, exy, eyy, visr_params, vels, resids)  # 2D grid output format
        ...
        [Ve, Vn, Se, Sn, rot_simple_visr, exx, exy, eyy, vels, resids] = constructed_object.compute(myvelfield)  # computing strain
        output_manager.outputs_2d(Ve, Vn, Se, Sn, rot_simple_visr, exx, exy, eyy, simple_visr_params, vels, resids)  # 2D grid output format
        ...
        [Ve, Vn, Se, Sn, rot_lag, exx, exy, eyy, vels, resids] = constructed_object.compute(myvelfield)  # computing strain
        output_manager.outputs_2d(Ve, Vn, Se, Sn, rot_lag, exx, exy, eyy, lag_params, vels, resids)  # 2D grid output format
        ...
        [Ve, Vn, Se, Sn, rot_geo, exx, exy, eyy, vels, resids] = constructed_object.compute(myvelfield)  # computing strain
        output_manager.outputs_2d(Ve, Vn, Se, Sn, rot_geo, exx, exy, eyy, geostats_params, vels, resids)  # 2D grid output format
